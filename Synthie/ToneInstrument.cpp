...
{
	CSineWave* sinewave = new CSineWave();
	sinewave->SetFreq(m_frequency);
	sinewave->SetAmplitude(m_amplitude);
	sinewave->SetSampleRate(GetSampleRate());
	
	m_source = new CARDecorator(sinewave);
