...
public:
    ...
    virtual double GetSamplePeriod() {return m_samplePeriod;}

    //! Set the sample rate
    virtual void SetSampleRate(double s) {m_sampleRate = s;  m_samplePeriod = 1/s;}
	...
	virtual double GetBPM() { return m_bpm; }

	//! Set the beats per minute
	virtual void SetBPM(double bpm) { m_bpm = bpm; }
